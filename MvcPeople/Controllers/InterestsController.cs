...
namespace MvcPeople.Controllers
{
    public class InterestsController : Controller
    {
        ...
        {
            var interests = db.Interests.Include(i => i.Person);
        ...
        public ActionResult Create([Bind(Include = "InterestID,PersonID,PossibleInterest")] Interest interest)
        {
            ...
            ViewBag.PersonID = new SelectList(db.People, "ID", "firstName", interest.PersonID);
            return View(interest);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "InterestID,PersonID,PossibleInterest")] Interest interest)
        {
            if (ModelState.IsValid)
            {
